...
pdf("CD8_CrOv.9pt_precision.recall.curves_by_maxCloneScores_for_8.signatures_20240425.pdf", width = 7, height = 5)
...
pdf("CD8_CrOv.9pt_precision.recall.curves_by_avgCloneScores_for_8.signatures_20240425.pdf", width = 7, height = 5)
ggplot(data = Res, aes(x = recall, y = precision, color = signature)) +
  geom_line() +
  #geom_point() +
  scale_color_manual(values = SigColor) +
...
# plot PR curves by average Clone Scores
pdf("CD8_CrOv.9pt_precision.recall.curves_by_CellScores_for_8.signatures_20240425.pdf", width = 7, height = 5)
ggplot(data = Res, aes(x = recall, y = precision, color = signature)) +
  geom_line() +
  #geom_point() +
  scale_color_manual(values = SigColor) +
