...
pdf("CD8_CrOv.9pt_110annotatedTCRs_AUC_and_pval.ttest_of_8signatures_by_max.CloneScores_20240502.pdf", width = 6, height = 5.3)
...
#plot(vdleun, print.auc=FALSE, col="#026554", lwd=2, legacy.axes=FALSE, add=TRUE)
...
#text(0.6, 0.25, paste("AUC :", round(vdleun$auc, 3)), adj = c(0, .5), col="#026554", cex = 0.7)
...
#text(0.4, 0.25, paste("p.val =", format.pval(test14$p.value)), adj = c(0, .5), col="#026554", cex = 0.7)
...
# Save all results
write.table(Res, "CD8_CrOv.9pt_110annotatedTCRs_ROC.results_of_8signatures_using_max.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestF, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.Fscore_of_8signatures_using_max.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestAUC, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.AUC_of_8signatures_using_max.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(CI, "CD8_CrOv.9pt_110annotatedTCRs_AUC_with_CI95_of_8signatures_using_max.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pdf("CD8_CrOv.9pt_precision.recall.curves_by_maxCloneScores_for_8.signatures_20240502.pdf", width = 6, height = 5.3)
...
# 2c. plot ROC_AUC curves
pdf("CD8_CrOv.9pt_110annotatedTCRs_AUC_and_pval.ttest_of_8signatures_by_avg.CloneScores_20240502.pdf", width = 6, height = 5.3)
plot(crov, print.auc=FALSE, col="#D2185C", lwd=2, legacy.axes=FALSE,
...
# Save all results
write.table(Res, "CD8_CrOv.9pt_110annotatedTCRs_ROC.results_of_8signatures_using_avg.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestF, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.Fscore_of_8signatures_using_avg.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestAUC, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.AUC_of_8signatures_using_avg.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(CI, "CD8_CrOv.9pt_110annotatedTCRs_AUC_with_CI95_of_8signatures_using_avg.CloneScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)


# Plot PR curves by avg Clone Scores
SigColor = c("#D2185C", "#318AD8", "#FFC107", "#644092", "#917D87", "#517D36", "#E06DBB", "#ADA919")


pdf("CD8_CrOv.9pt_precision.recall.curves_by_avgCloneScores_for_8.signatures_20240502.pdf", width = 6, height = 5.3)
...
pdf("CD8_CrOv.9pt_110annotatedTCRs_AUC_and_pval.ttest_of_8signatures_by_CellScores_20240502.pdf", width = 6, height = 5.3)
plot(crov, print.auc=FALSE, col="#D2185C", lwd=2, legacy.axes=FALSE,
...
# Save all results
write.table(Res, "CD8_CrOv.9pt_110annotatedTCRs_ROC.results_of_8signatures_using_CellScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestF, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.Fscore_of_8signatures_using_CellScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(BestAUC, "CD8_CrOv.9pt_110annotatedTCRs_bestThreshold.for.AUC_of_8signatures_using_CellScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(CI, "CD8_CrOv.9pt_110annotatedTCRs_AUC_with_CI95_of_8signatures_using_CellScores_20240502.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pdf("CD8_CrOv.9pt_precision.recall.curves_by_CellScores_for_8.signatures_20240502.pdf", width = 6, height = 5.3)
...
```
# 20240525, 20240427 & 20240502 STOP HERE!!!
...
pdf("intgHarCD8_CrOv.9pt_stacked.bar.plot_for_common_and_different_TRprediction_of_2399.UNANNOTATED.clones_by_CrOv.9pt_and_Li_signatures_20230927.pdf", width = 5, height = 5.3.5)
...
pdf("intgHarCD8_CrOv.9pt_stacked.bar.plot_per.patient_for_common_and_different_TRprediction_of_2399.UNANNOTATED.clones_by_CrOv.9pt_and_Li_signatures_20230927.pdf", width = 10, height = 5.3.5)
